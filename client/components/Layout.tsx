    ...
    <footer className="border-t border-border/60 bg-gradient-to-b from-background to-background/40">
      <div className="container py-10 grid gap-8 md:grid-cols-3">
        <div>
          <div className="flex items-center gap-2">
            <img src="https://cdn.builder.io/api/v1/image/assets%2Fec69bd5deeba4d6a81033567db96cbc0%2Fa179a2c715a64edaafe6df770c43ddf5?format=webp&width=800" alt="Brainrot Market logo" className="h-8 w-8 rounded-md object-cover" />
            <span className="font-display text-lg">Brainrot Market <span role="img" aria-label="France">🇫🇷</span></span>
          </div>
      ...
      <div className="border-t border-border/60 py-4 text-center text-xs text-foreground/60">
        © {new Date().getFullYear()} Brainrot Market 🇫🇷 — Projet communautaire non affilié à Roblox.
      </div>
    </footer>
  );
}
